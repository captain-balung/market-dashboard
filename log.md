...
- **類型**：決策
- **範圍與摘要**：Phase 4 視覺風格拍板 — **TradingView 風 + 綠漲紅跌**。
- **觸發來源**：人類指示
- **決策內容**：
  - 整體風格：TradingView 風（深底交易終端、緊湊、monospace 數字、密集面板）。
  - 漲跌色票：emerald-500（#10b981）漲、rose-500（#ef4444）跌、zinc-500 持平。
  - 背景/卡面/邊框：dark zinc-950/900/800、light zinc-50/white/200。
  - design.md 同步更新拍板區、roadmap 阻塞表移除這兩項。
- **風險等級**：低
- **後果**：解 Phase 4 阻塞、可立即推進 4.1～4.7。
